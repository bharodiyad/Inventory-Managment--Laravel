...
Route::any('greeting/{id}',function($id){
...
Route::controller(CustomerController::class)->group(function () {
    ...
    Route::get('/customer/delete/{id}', function (User $user) {
        return $user->email;
    })->name('customer.delete')->withTrashed();
...
Route::controller(DefaultController::class)->group(function(){
    Route::get('/test', 'getUser')->name('test');    
