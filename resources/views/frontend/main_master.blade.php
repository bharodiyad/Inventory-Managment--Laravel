...
<html class="no-js" lang="en">
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/frontend/assets/img/favicon.png') }}">
    ...
    <body>
        ...
        <script src="{{ asset('public/frontend/assets/js/element-in-view.js') }}"></script>
