            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{asset('public/logo/share.png')}}" alt="" style="width: 375px;
                                height: auto;">
                            </div>
                            <div class="col-md-6">
                                <div class="text-center mt-4">
                                    <div class="mb-3">
                                        <a href="index.html" class="auth-logo">
                                            <img src="{{ asset('public/backend/assets/images/logo-dark.png') }}" height="30" class="logo-dark mx-auto" alt="">
                                            <img src="{{ asset('public/backend/assets/images/logo-light.png') }}" height="30" class="logo-light mx-auto" alt="">
                                        </a>
                                    </div>
                                </div>
